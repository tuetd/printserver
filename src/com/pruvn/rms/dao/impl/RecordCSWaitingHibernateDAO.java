...
/**
 * <p>Hibernate DAO layer for RecordCSWaiting</p>
 * <p>Generated at Mon Jul 11 14:56:25 ICT 2011</p>
 *
 * @author Salto-db Generator v1.0.16 / EJB3 + Spring/Hibernate DAO
 * @see http://www.hibernate.org/328.html
 */
public class RecordCSWaitingHibernateDAO extends
		AbstractHibernateDAO<RecordCSWaiting, Integer> implements
		RecordCSWaitingDAO {
	...
	public List<RecordCSWaiting> findAllRecordCSWaitings_ACL(final String username, final String stage, final Map<String, Object> filters) {
		return getHibernateTemplate().execute(new HibernateCallback() {
            public Object doInHibernate(final Session session) throws HibernateException, SQLException {
        		...
        		query.addEntity(RecordCSWaiting.class);
        		List<RecordCSWaiting> result = query.list();
        		return result;
            }
        });
	}
