...
@MappedSuperclass
@Table(name = "RM_TB6")
public class TB6 implements Serializable {
	...
	@Column(name="ID")
	@Id
	@GenericGenerator(name = "generator", strategy = "sequence-identity", parameters = @Parameter(name = "sequence", value = "RM_TB6_SEQ"))
	...
	@Column(name="RECEIVE_FROM_COLLECTION_DATE")
	@Temporal(TemporalType.TIMESTAMP)
    private Date receiveFromCollectionDate     ;
	...
	/**
	 * @return the receiveFromCollectionDate
	 */
	public Date getReceiveFromCollectionDate() {
		return receiveFromCollectionDate;
	}



	/**
	 * @param receiveFromCollectionDate the receiveFromCollectionDate to set
	 */
	public void setReceiveFromCollectionDate(Date receiveFromCollectionDate) {
		this.receiveFromCollectionDate = receiveFromCollectionDate;
	}
