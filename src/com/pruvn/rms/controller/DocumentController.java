...
@Controller
public class DocumentController extends BaseRecordController {
	...
	public String index(Model model, HttpServletRequest request,
		...
		logger.debug("reach DocumentController$autodebit...");
		...
		List<DocumentMaintenance> list = autoDebitService.getAllDocument(username, "", filters);
	...
	/*@Transactional
	@RequestMapping(value = "/document/index", method = RequestMethod.POST)
