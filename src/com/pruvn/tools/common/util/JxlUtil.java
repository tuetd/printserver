...
public class JxlUtil {
	...
	public WritableCellFormat createFormattedCell(int pointSize, Border border, BorderLineStyle lineStyle, jxl.write.WritableFont.FontName fontName){		
		...
		try {
			writableCellFormat.setBorder(border, lineStyle);
			writableCellFormat.setFont(new WritableFont(fontName, pointSize));			
		} catch (WriteException e) {
			throw new JxlUtilException(e);
		}
		return writableCellFormat;
	...
	public WritableCellFormat createFormattedCell(int pointSize, jxl.write.WritableFont.FontName fontName, boolean isBold){		
		WritableCellFormat writableCellFormat = new WritableCellFormat();				
		if (isBold) {
			writableCellFormat.setFont(new WritableFont(fontName, pointSize, WritableFont.BOLD));
		}
		else {
			writableCellFormat.setFont(new WritableFont(fontName, pointSize));
		}		
	...
	public WritableCellFormat createFormattedCell(int pointSize,jxl.write.WritableFont.FontName fontName, Alignment alignment){
		WritableFont font = new WritableFont(null!=fontName?fontName:jxl.write.WritableFont.TIMES, pointSize);
		WritableCellFormat writableCellFormat = new WritableCellFormat(font);		
		if(null == alignment){
			alignment = Alignment.CENTRE;
		}
	...
	public void addCellToSheet(int column, int row, double data,WritableCellFormat format,WritableSheet sheet){
		try {
			if(null != format){
				sheet.addCell(new jxl.write.Number(column, row, data, format));
			}else{
	...
	public void addCellToSheet(int column, int row, Date data,WritableCellFormat format,WritableSheet sheet, String dateformat){
		try {
			if(null != dateformat){
				sheet.addCell(new jxl.write.DateTime(column, row, data, new WritableCellFormat(new DateFormat(dateformat))));
			}else{
				sheet.addCell(new jxl.write.DateTime(column, row, data));
			}
		} catch (RowsExceededException e) {
			throw new JxlUtilException(e);
		} catch (WriteException e) {
