...
public class WindowUtil {
	private static final String CMD_START = "cmd /c net start \"";
    private static final String CMD_STOP = "cmd /c net stop \"";
    ...
    public static Process execCmd(String cmdLine) throws Exception {
