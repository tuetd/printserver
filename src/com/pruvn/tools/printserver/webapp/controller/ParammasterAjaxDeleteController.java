...
/**
 * <p>
 * Spring controller to delete a Parammaster
 * </p>
 * <p>
 ...
 *         Spring MVC webapp
 */
public class ParammasterAjaxDeleteController extends AbstractController {
	...
	protected ModelAndView handleRequestInternal(HttpServletRequest request,
		...
		if (request.getParameter("parammasterId") != null) {
			parammasterDAO.deleteById(getPkFromRequest(request));
		}

		// TODO: when it will be ajax : return null;
		return new ModelAndView("redirect:/listParammaster.html");
	}
