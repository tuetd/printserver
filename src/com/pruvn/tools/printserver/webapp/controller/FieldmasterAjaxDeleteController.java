...
/**
 * <p>
 * Spring controller to delete a Fieldmaster
 * </p>
 * <p>
 ...
 *         Spring MVC webapp
 */
public class FieldmasterAjaxDeleteController extends AbstractController {
	...
	protected ModelAndView handleRequestInternal(HttpServletRequest request,
		...
		if (request.getParameter("fieldmasterId") != null) {
			fieldmasterDAO.deleteById(getPkFromRequest(request));
		}

		// TODO: when it will be ajax : return null;
		return new ModelAndView("redirect:/listFieldmaster.html");
	}
