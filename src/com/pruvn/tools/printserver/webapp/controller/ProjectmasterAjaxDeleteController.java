...
/**
 * <p>
 * Spring controller to delete a Projectmaster
 * </p>
 * <p>
 ...
 *         Spring MVC webapp
 */
public class ProjectmasterAjaxDeleteController extends AbstractController {
	...
	protected ModelAndView handleRequestInternal(HttpServletRequest request,
		...
		if (request.getParameter("projectmasterId") != null) {
			projectmasterDAO.deleteById(getPkFromRequest(request));
		}

		// TODO: when it will be ajax : return null;
		return new ModelAndView("redirect:/listProjectmaster.html");
	}
