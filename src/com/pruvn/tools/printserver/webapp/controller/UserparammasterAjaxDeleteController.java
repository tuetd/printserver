...
/**
 * <p>
 * Spring controller to delete a Userparammaster
 * </p>
 * <p>
 ...
 *         Spring MVC webapp
 */
public class UserparammasterAjaxDeleteController extends AbstractController {
	...
	protected ModelAndView handleRequestInternal(HttpServletRequest request,
		...
		if (request.getParameter("userparammasterId") != null) {
			userparammasterDAO.deleteById(getPkFromRequest(request));
		}

		// TODO: when it will be ajax : return null;
		return new ModelAndView("redirect:/listUserparammaster.html");
	}
