<%@ include file="/common/taglibs.jsp"%>
	<head>
		<title><fmt:message key="menu.search.fileparammasterList.title"/></title>
	    <content tag="heading"><fmt:message key="menu.search.fileparammasterList.title"/></content>
	    <meta name="menu" content="Fileparammaster"/>
	</head>

<fieldset>
		<form:form commandName="fileparammaster" action="searchFileparammaster.html" method="post">
			<ul>
