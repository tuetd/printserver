<%@ include file="/common/taglibs.jsp"%>
	<head>
		<title><fmt:message key="menu.search.filetypemasterList.title"/></title>
	    <content tag="heading"><fmt:message key="menu.search.filetypemasterList.title"/></content>
	    <meta name="menu" content="Filetypemaster"/>
	</head>

<fieldset>
		<form:form commandName="filetypemaster" action="searchFiletypemaster.html" method="post">
			<ul>
