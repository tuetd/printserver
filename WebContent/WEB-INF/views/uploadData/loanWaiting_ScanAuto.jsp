...
<div id="container">
	<div id="header" class="info">
		<b>Disbursal Loan Waiting - Documents Scan Upload</b>
	</div>

	<sec:authorize access="hasAnyRole('ROLE_ADMIN','ROLE_RM_RMT')">
	<form:form commandName="uploadItem" method="post"
		enctype="multipart/form-data" action="${pageContext.request.contextPath}/uploadData/loanWaiting_ScanAuto.html">
		<fieldset>
