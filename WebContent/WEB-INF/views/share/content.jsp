...
<div style="margin-top: 5px;padding: 5px; background: #EBE5D9;">
	...
	<fieldset style="margin-top:10px">
	<legend>Transaction logs</legend>
	...
	<%-- <table class="bordered">
		...
		<tbody>
			<c:forEach items="${logTransactions}" varStatus="item"
				var="transaction">
				<tr>
					<td>${fn:length(logTransactions) - item.count + 1}</td>
					<td>${transaction.createBy }</td>
					<td><fmt:formatDate pattern="dd-MM-yyyy HH:mm:ss"
							value="${transaction.logDate }" /></td>
					<td>${transaction.curStage }</td>
