...
<div id="container">
	<div id="header" class="info">
		<b>Foreclosure Send List</b>
	</div>

<form:form commandName="filterMRCForm" method="post" action="${pageContext.request.contextPath}/foreclosure/send.html">
		...
		<table>
			<tbody>
				...
				<tr>					
					...
					<td><label> Date Send(From XPU)</label>
					</td>
...
<form name="displ" method="post">
	...
	<br>
	<display:table size="resultSize" export="true" cellpadding="1" cellspacing="1" id="data" name="recordList" class="tftable" requestURI="/foreclosure/send.html" pagesize="${pageSize}">
...
<div id="popup-waiting-div" class="hidden dialog" title="Waiting">
