...
<div id="container">
	<div id="header" class="info">
		<b>Foreclosure Complete List</b>
	</div>

<form:form commandName="filterMRCForm" method="post" action="${pageContext.request.contextPath}/foreclosure/complete.html">
...
<form name="displ" method="post">
	...
	<br>
	<display:table size="resultSize" export="true" cellpadding="1" cellspacing="1" id="data" name="recordList" class="tftable" requestURI="/foreclosure/complete.html" pagesize="${pageSize}">
...
<div id="popup-return-div" class="hidden dialog" title="Return Foreclosure">
