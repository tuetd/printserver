...
<div id="container">
	<div id="header" class="info">
		<b>TB6 Waiting List</b>
	</div>

<form:form commandName="filterMRCForm" method="post" action="${pageContext.request.contextPath}/tb6/waiting.html">
...
<form name="displ" method="post">
	...
	<br>
	<display:table size="resultSize" export="true" cellpadding="1" cellspacing="1" id="data" name="recordList" class="tftable" requestURI="/tb6/waiting.html" pagesize="${pageSize}">
