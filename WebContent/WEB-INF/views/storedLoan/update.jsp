...
<div id="container">
	<div id="header" class="info">
		<b>Update Status Storing</b>
	</div>
	<sec:authorize access="hasAnyRole('ROLE_ADMIN','ROLE_RM_RMT')">
	<form:form commandName="uploadItem" method="post"
		enctype="multipart/form-data" action="${pageContext.request.contextPath}/storedLoan/update.html">
		<fieldset>
		...
		<c:if test="${fn:length(existList) gt 0}">
				...
				<font size="5" color="red">Total ${fn:length(existList)} rows is invalid. Click here to see more details. </font></span>
			...
			<table style="width: 650px">
				<tr>
					...
					<td style="width:100px">
						<div id="btnGroup" >
							<input type="submit" name="btnUpload" value="Update storedLoan"
					...
					<td>
					             <a target="_blank" style="margin-left:50px;color: blue; font-weight: bold;"
									href="<%=request.getContextPath()%>/templates/updateStoredTemplate.xls">Download
									Template </a>
					</td>	
				</tr>
			</table>
